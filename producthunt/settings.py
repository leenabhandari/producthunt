...
SECRET_KEY = 'rd!_ko@0wq@pa5yzeld1h4zn=*%yo3(7$qfdr(um9!6hc)e(=w'
...
#media_root and media_url need not be the same. Url is where stuff is gonna be accessible from .
MEDIA_URL = '/media/'
